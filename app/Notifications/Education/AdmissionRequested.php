...
class AdmissionRequested extends Notification implements ShouldQueue
{
    ...
    {
        $subject = __('Admission Requested');
        $description = __('Your admission has been requested.');
