...
class AdmissionRejected extends Notification implements ShouldQueue
{
    ...
    {
        $subject = __('Admission Incomplete');
        $description = __('Your admission has been rejected. Please, redo the admission with more details.');
