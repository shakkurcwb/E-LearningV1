@component('shared.components.block.default', [
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-vcenter">
            <thead>
                <tr>
                    <th style="width: 50%;">@lang('education.tables.sessions.headers.identity')</th>
                    <th class="text-center" style="width: 30%;">@lang('education.tables.sessions.headers.details')</th>
                    <th class="text-center" style="width: 10%;">@lang('education.tables.sessions.headers.status')</th>
