...
@section('content')
    ...
    @hero_image([
        'title' => 'general.pages.help.title',
        'subtitle' => 'general.pages.help.subtitle',
        'greetings' => false,
    ])
    ...
    <div class="content content-boxed overflow-hidden">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 invisible" data-toggle="appear" data-class="animated fadeInDown">
                <a class="block block-bordered block-rounded block-link-shadow" href="#faq1">
            ...
            <div class="col-sm-6 col-md-3 invisible" data-toggle="appear" data-timeout="200" data-class="animated fadeInDown">
                <a class="block block-bordered block-rounded block-link-shadow" href="#faq2">
                    <div class="block-content block-content-full border-bottom text-center">
                        <div class="py-3">
            ...
            <div class="col-sm-6 col-md-3 invisible" data-toggle="appear" data-timeout="600" data-class="animated fadeInDown">
                <a class="block block-bordered block-rounded block-link-shadow" href="#faq3">
                    <div class="block-content block-content-full border-bottom text-center">
                        <div class="py-3">
    ...
    <div class="bg-body-dark">
        <div class="content content-full">
            <div class="my-5 text-center">
                ...
                <a class="btn btn-rounded btn-success px-4 py-2 invisible"
                    data-toggle="appear" data-class="animated bounceIn"
                    href="{{ url('/feedback') }}">Contact Us</a>
            </div>
        </div>
    </div>
    <!-- END Contact Us -->
